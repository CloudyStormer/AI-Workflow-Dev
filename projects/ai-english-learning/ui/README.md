...
- 产品逻辑：以已批准的 `docs/01-prd.md` v1.1 为准。
- 行内字母槽交互：以已批准的 `docs/03-ui-prompt.md` v1.1 为准；图片没有单独展示的默认、输入、提示、编辑、退格、粘贴、未完成、错误修正、正确、软键盘和无障碍状态均按该 Prompt 实现。
...
- 版本：v1.1
- SHA256：`2e882df4029a098bc8679a628b70379fddbb88c2ebc01df5c26e9062a19e3038`
- 状态：approved
